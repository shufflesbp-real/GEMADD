...
def calculate_and_print_all_metrics(result_df, output_file='/home/Byomakesh/Unified-medical-KG/mddial-diagnosis_new/evaluation_metrics.txt',elapsed_time=None):
    ...
    output_lines.append(f"\nTime taken per dialogue: {elapsed_time/len(result_df):.2f} seconds")
    output_lines.append("\n" + "=" * 60)
