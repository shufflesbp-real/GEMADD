...
def calc_dis_rank_1(new_graph, dialogue_id):
    """
    Calculate disease ranking using Signed Random Walk with Restart (SRWR).
    """
    try:
        srwr = SRWR()
        ...
        edge_file = f"/home/Byomakesh/ours-diagnosis/mddial-diagnosis/graph_edges/graph_edges_{dialogue_id}.txt"
        ...
        c, epsilon, beta, gamma, max_iters = 0.15, 1e-9, 0.6, 0.4, 200
